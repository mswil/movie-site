$.get("http://www.omdbapi.com/?i=tt3896198&apikey=d4428604", function(data,status){
    $(".carousel-item:first").css("background-image", "url(" + data.Poster + ")");
});

// $.get("http://www.omdbapi.com/?i=tt0120338&apikey=d4428604", function(data,status){
...
for(var i = 0; i < 6; i++){
    $.get("http://www.omdbapi.com/?i=" + movies[i] + "&apikey=d4428604", function(data, status){
